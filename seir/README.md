...
This project is the `seir/` directory of the public research-projects repository.
Run the commands below from this directory. The [version index](VERSIONS.md)
links to the recoverable v1.0–v3.7 research history. The typhoon project in
`../typhoon/` is independent.
